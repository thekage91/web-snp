...
(function BootstrapAngoose() {
		...
		"paths": {
			...
			"mutationTaster": {
				...
				"options": {
					...
					"validate": [
						"not-supported",
						"mutationTaster cannot be blank"
					]
				},
				"_index": null,
				"isRequired": true
			...
			"mutationAssessor": {
				...
				"options": {
					...
					"validate": [
						"not-supported",
						"mutationAssessor cannot be blank"
					]
				},
				"_index": null,
				"isRequired": true
		...
		"paths": {
			...
			"patientHealthStatus": {
				...
				"options": {
					...
					"validate": [
						"not-supported",
						"patientHealthStatus cannot be blank"
					]
				},
				"_index": null,
				"isRequired": true
			...
			"sequencerModel": {
				...
				"options": {
					...
					"validate": [
						"not-supported",
						"sequencerModel cannot be blank"
					]
				},
				"_index": null,
				"isRequired": true
			...
			"referenceGenome": {
				...
				"options": {
					...
					"validate": [
						"not-supported",
						"referenceGenome cannot be blank"
					]
				},
				"_index": null,
				"isRequired": true
	...
	"User": {
		...
		"methods": {
			...
			"isAdmin": "$PROXIED$",
			"isLicensed": "$PROXIED$",
			"authenticate": "$PROXIED$",
			"makeSalt": "$PROXIED$",
			"hashPassword": "$PROXIED$",
			"save": "$PROXIED$",
			"remove": "$PROXIED$",
			"populate": "$PROXIED$"
		},
		...
		"paths": {
			...
			"genotypeQuality": {
				...
				"options": {
					...
					"validate": [
						"not-supported",
						"genotypeQuality cannot be blank"
					]
				},
				"_index": null,
				"isRequired": true
			...
			"altFilteredReads": {
				...
				"options": {
					...
					"validate": [
						"not-supported",
						"altFilteredReads cannot be blank"
					]
				},
				"_index": null,
				"isRequired": true
			...
			"genotypesLikelihood": {
				...
				"options": {
					...
					"validate": [
						"not-supported",
						"genotypesLikelihood cannot be blank"
					]
				},
				"_index": null,
				"isRequired": true
			...
			"haplotypeScore": {
				...
				"options": {
					...
					"validate": [
						"not-supported",
						"haplotypeScore cannot be blank"
					]
				},
				"_index": null,
				"isRequired": true
