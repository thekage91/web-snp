...
The syntax for doing this is explicated in the example, where it is supposed to want to model a user with an attribute 'name' of type string: \begin {verbatim} UserSchema = new Schema ({
  / / attribute
  name: {
         type: String,
         required: true,
